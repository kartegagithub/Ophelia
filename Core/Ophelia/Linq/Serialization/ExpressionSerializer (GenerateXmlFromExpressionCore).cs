...
namespace Ophelia.Linq.Serialization
{
	...
	public partial class ExpressionSerializer
	{
		...
		public XElement GenerateXmlFromExpressionCore(Expression e)
		{
			...
			else if (e is System.Linq.Expressions.DynamicExpression)
			{
				return DynamicExpressionToXElement((System.Linq.Expressions.DynamicExpression)e);
			}
		...
		internal XElement DynamicExpressionToXElement(System.Linq.Expressions.DynamicExpression e)
		{
			object value;
