...
{
	public class ConditionalFilterBoxField : Field
	{
		private string sNewLinkUrl = "";
		private string sEditLinkUrl = "";
		private bool bEditInNewWindow = false;
		public new View.Web.Controls.ConditionalFilterBox Control {
		...
		{
			base.CreateControls();
			this.oControl = new View.Web.Controls.ConditionalFilterBox(this.MemberName);
		}
		public ConditionalFilterBoxField(ref FieldCollection Collection, string Header, string MemberName) : base(Collection, Header, MemberName)
		{
		}
	}
}
